...
const std::vector<Edge> &Mesh::getHalfEdges() const {
  return _halfEdges;
}

std::vector<Edge> &Mesh::getHalfEdges() {
  return _halfEdges;
}

QVector2D Mesh::evaluateCubicBSpline(const Edge &halfEdge, const double param) {
